...
public class BottomPopupOption {
    ...
    private void addView(View v) {
        ...
        if (options != null && options.length > 0) {
            for (int i = 0; i < options.length; i++) {
                View item = LayoutInflater.from(mContext).inflate(R.layout.activity_popup_item, null);
    ...
    public void showPopupWindow() {
        View popupWindow_view = LayoutInflater.from(mContext).inflate(R.layout.activity_basepopup_bottom, null);
        //添加子View
