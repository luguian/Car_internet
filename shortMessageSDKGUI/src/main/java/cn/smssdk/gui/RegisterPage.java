...
public class RegisterPage extends FakeActivity implements OnClickListener,
	...
	public void onCreate() {
		...
		if (layout != null) {
			...
			tvCountry.setTextColor(Color.parseColor("#CC1E90FF"));
			...
			btnNext.setBackgroundColor((Color.parseColor("#661E90FF")));
			if (etPhoneNum.getText().length() > 0) {
				...
				if (resId > 0) {
					...
					btnNext.setBackgroundColor((Color.parseColor("#CC1E90FF")));
				}
			}
	...
	public void showDialog(final String phone, final String code) {
		...
		if (resId > 0) {
			...
			if (layout != null) {
				...
				((TextView) dialog.findViewById(Res.id.tv_phone)).setTextColor(0x661E90FF);
			
				SharedPreferences sPreferences=getContext().getSharedPreferences("nickname", getContext().MODE_PRIVATE);       
				Editor editor=sPreferences.edit();
				Toast.makeText(getContext(), phone,
				...
				((Button) dialog.findViewById(Res.id.btn_dialog_ok)).setTextColor(0xff000000);
				...
				((Button) dialog.findViewById(Res.id.btn_dialog_cancel)).setTextColor(0xff000000);
